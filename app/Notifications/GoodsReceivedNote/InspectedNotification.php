...
class InspectedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('Your GRN form ' . $this->request->sn . ' inspection note has been created.')
            ->action('View Request', $url)
            ->line('Request has been forwarded to the approval team. ' .
