...
interface PermissionUtils
{
    const  Permissions = [
        ...
        ['name' => 'organization.clients.view', 'group' => 'clients',
            'description' => 'User can view all clients'],
        ['name' => 'organization.clients.create', 'group' => 'clients',
            'description' => 'User can create a client'],
        ['name' => 'organization.clients.edit', 'group' => 'clients',
            'description' => 'User can edit client details'],
        ['name' => 'organization.clients.delete', 'group' => 'clients',
            'description' => 'User can delete a client'],
